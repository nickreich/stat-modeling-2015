...
---- | ----- | --- | ------- | ------------------ | -------
 ...
 3   | Feb | 3, 5   | Least squares, multiple linear regression | [Lec 3](../assets/lectures/lecture3-slr-anova/lecture3-SLR-anova.pdf), [Lec 4](../assets/lectures/lecture4-mlr-intro/lecture3-mlr-intro.pdf), [Lab 2](../assets/labs/lab2-intro-mlr.pdf) | _ISL_ Ch 3.2-3.3; _PR_ Ch 2.
 4   |     | 10, 12 | MLR: estimation, model formulation | | _ISL_ Ch 3.2-3.3; _PR_ Ch 2.
